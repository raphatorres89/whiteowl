...
import com.raphaowl.whiteowl.service.ItemGroupingService;
...
public class ItemController {
    ...
    private final ItemGroupingService itemGroupingService;
    ...
    public String detail(@PathVariable String category, Model model) {
        ...
        ItemGroupingService.GroupedItems groupedItems = itemGroupingService.build(categoryEnum, items);
        model.addAttribute(groupedItems.modelAttribute(), groupedItems.itemsByType());
